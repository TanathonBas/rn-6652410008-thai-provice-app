...
export default function TempleDetail() {
  ...
  const [item, setItem] = useState<TempleRow | null>(null);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setItem((data ?? null) as TempleRow | null);
      } finally {
  ...
  return (
    <AnimatedScreen title={item?.name ?? "รายละเอียดวัด"} backTarget="/temple">
      {loading ? (
