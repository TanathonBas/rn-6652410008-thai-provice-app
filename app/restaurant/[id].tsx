...
export default function RestaurantDetail() {
  ...
  const [item, setItem] = useState<RestaurantRow | null>(null);
  ...
  useEffect(() => {
    ...
    (async () => {
      try {
        ...
        if (!cancelled) setItem((data ?? null) as RestaurantRow | null);
      } finally {
  ...
  return (
    <AnimatedScreen title={item?.name ?? "รายละเอียดร้านอาหาร"} backTarget="/restaurant">
      {loading ? (
